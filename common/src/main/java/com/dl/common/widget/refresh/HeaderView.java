...
public class HeaderView extends FrameLayout implements PtrUIHandler{
    ...
    private void init(Context context) {
        headView = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.refresh_layout,this,true);
        mImage = (ImageView) findViewById(R.id.img_pull_to_refresh);
        load_text = ((TextView) findViewById(R.id.pull_to_load_text));
        load_text.setText("下拉刷新");
